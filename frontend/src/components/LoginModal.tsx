...
export default function LoginModal({ login }: { login: boolean }): JSX.Element {
    ...
    return (
        <div id="authentication-modal" tabIndex={-1} className={`${ds} absolute z-50 fixedœœ p-4 w-96 focus:bg-primary-600 mx-auto overflow-x-hidden overflow-y-auto loginModal `}>
                    ...
                    <div className="px-6 py-6 lg:px-8">
                        ...
                        <form className="space-y-6" action="#">
                            ...
                            <div className="text-sm font-medium text-gray-500 dark:text-gray-300">
                                Not registered? <a href="/RegisterFrom" className="text-blue-700 hover:underline dark:text-blue-500">Create account</a>
                            </div>
                        </form>
                    </div>
                </div>
